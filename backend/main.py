...
Startpunktet for hele applikasjonen. 
Setter opp FastAPI, CORS (tillater forespørsler fra innocents.no), 
og kobler inn alle routes. Oppretter også databasetabeller automatisk ved oppstart.
